...
var BGSCENE, BGSCENE_SUB1, BGSCENE_SUB2, CONTROL, GAMESCENE, GAMESCENE_SUB1, GAMESCENE_SUB2, JSLog, LABEL, PHYSICS, SPRITE, TOPSCENE, WEBGL, core, createObject, debugwrite, lapsedtime, nop, rand, removeObject, rootScene, sprintf, _DEBUGLABEL, _getNullObject, _main, _objects, _originObject, _scenes, _stationary,
  __slice = [].slice;
...
_stationary = (function() {
  ...
  _stationary.prototype.setAnimationToOnce = function(animnum) {
    this._beforeAnimnum = this.sprite.animnum;
    this.sprite.animnum = animnum;
    this._dispframe = 0;
